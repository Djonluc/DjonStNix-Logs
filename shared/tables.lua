-- ==============================================================================
-- shared/tables.lua
-- Weapon names, death causes, and explosion type mappings.
-- Used by client-side detection and server-side logging.
-- ==============================================================================

LogTables = {}

-- ==============================================================================
-- WEAPON NAMES (Hash → Friendly Name)
-- ==============================================================================
LogTables.WeaponNames = {
    -- Melee
    ...
    [tostring(GetHashKey('WEAPON_TACTICALRIFLE'))]    = 'Tactical Rifle',
...
-- ==============================================================================
-- DEATH CAUSES (Hash → { Category, Weapon Name })
-- ==============================================================================
LogTables.DeathCauses = {
    -- Melee
    ...
    -- Pistol
    [GetHashKey('WEAPON_SNSPISTOL')]       = {'Shot',         'SNS Pistol'},
    [GetHashKey('WEAPON_HEAVYPISTOL')]     = {'Shot',         'Heavy Pistol'},
    [GetHashKey('WEAPON_VINTAGEPISTOL')]   = {'Shot',         'Vintage Pistol'},
    [GetHashKey('WEAPON_PISTOL')]          = {'Shot',         'Pistol'},
    [GetHashKey('WEAPON_APPISTOL')]        = {'Shot',         'AP Pistol'},
    [GetHashKey('WEAPON_COMBATPISTOL')]    = {'Shot',         'Combat Pistol'},
    [GetHashKey('WEAPON_PISTOL50')]        = {'Shot',         'Pistol .50'},
    [GetHashKey('WEAPON_REVOLVER')]        = {'Shot',         'Heavy Revolver'},
    ...
    -- Shotgun
    [GetHashKey('WEAPON_BULLPUPSHOTGUN')]  = {'Blasted',      'Bullpup Shotgun'},
    [GetHashKey('WEAPON_ASSAULTSHOTGUN')]  = {'Blasted',      'Assault Shotgun'},
    [GetHashKey('WEAPON_DBSHOTGUN')]       = {'Blasted',      'Double Barrel Shotgun'},
    [GetHashKey('WEAPON_PUMPSHOTGUN')]     = {'Blasted',      'Pump Shotgun'},
    [GetHashKey('WEAPON_HEAVYSHOTGUN')]    = {'Blasted',      'Heavy Shotgun'},
    [GetHashKey('WEAPON_SAWNOFFSHOTGUN')]  = {'Blasted',      'Sawnoff Shotgun'},
    ...
    [GetHashKey('WEAPON_DROWNING_IN_VEHICLE')] = {'Drowned in Vehicle', nil},
    [GetHashKey('WEAPON_FALL')]            = {'Fell from a height', nil},
    [-842959696]                           = {'Fell from a height', nil},
}

-- ==============================================================================
-- EXPLOSION TYPES (Index → Friendly Name)
-- ==============================================================================
LogTables.ExplosionTypes = {
    'GRENADE', 'GRENADELAUNCHER', 'STICKYBOMB', 'MOLOTOV', 'ROCKET',
    'TANKSHELL', 'HI_OCTANE', 'CAR', 'PLANE', 'PETROL_PUMP', 'BIKE',
    'DIR_STEAM', 'DIR_FLAME', 'DIR_GAS_CANISTER', 'BOAT', 'SHIP_DESTROY',
    'TRUCK', 'BULLET', 'SMOKEGRENADELAUNCHER', 'SMOKEGRENADE', 'BZGAS',
    'FLARE', 'GAS_CANISTER', 'EXTINGUISHER', 'PROGRAMMABLEAR', 'TRAIN',
    'BARREL', 'PROPANE', 'BLIMP', 'DIR_FLAME_EXPLODE', 'TANKER',
    'PLANE_ROCKET', 'VEHICLE_BULLET', 'GAS_TANK', 'BIRD_CRAP', 'RAILGUN',
    'BLIMP2', 'FIREWORK', 'SNOWBALL', 'PROXMINE', 'VALKYRIE_CANNON',
    'AIR_DEFENCE', 'PIPEBOMB', 'VEHICLEMINE', 'EXPLOSIVEAMMO', 'APCSHELL',
    'BOMB_CLUSTER', 'BOMB_GAS', 'BOMB_INCENDIARY', 'BOMB_STANDARD', 'TORPEDO',
    'TORPEDO_UNDERWATER', 'BOMBUSHKA_CANNON', 'BOMB_CLUSTER_SECONDARY',
    'HUNTER_BARRAGE', 'HUNTER_CANNON', 'ROGUE_CANNON', 'MINE_UNDERWATER',
    'ORBITAL_CANNON', 'BOMB_STANDARD_WIDE', 'EXPLOSIVEAMMO_SHOTGUN',
    'OPPRESSOR2_CANNON', 'MORTAR_KINETIC', 'VEHICLEMINE_KINETIC',
    'VEHICLEMINE_EMP', 'VEHICLEMINE_SPIKE', 'VEHICLEMINE_SLICK',
    'VEHICLEMINE_TAR', 'SCRIPT_DRONE', 'RAYGUN', 'BURIEDMINE', 'SCRIPT_MISSIL'
}

LogTables.ExplosionNames = {
    ['GRENADE'] = 'Grenade', ['GRENADELAUNCHER'] = 'Grenade Launcher',
    ['STICKYBOMB'] = 'Sticky Bomb', ['MOLOTOV'] = 'Molotov', ['ROCKET'] = 'Rocket',
    ['TANKSHELL'] = 'Tank Shell', ['HI_OCTANE'] = 'HI_OCTANE', ['CAR'] = 'Vehicle: Car',
    ['PLANE'] = 'Vehicle: Plane', ['PETROL_PUMP'] = 'Petrol Pump', ['BIKE'] = 'Vehicle: Bike',
    ['DIR_STEAM'] = 'Steam', ['DIR_FLAME'] = 'Flame', ['DIR_GAS_CANISTER'] = 'Gas Canister',
    ['BOAT'] = 'Vehicle: Boat', ['SHIP_DESTROY'] = 'Ship', ['TRUCK'] = 'Vehicle: Truck',
    ['BULLET'] = 'Exploding Bullet', ['SMOKEGRENADELAUNCHER'] = 'Smoke Grenade (Launcher)',
    ['SMOKEGRENADE'] = 'Smoke Grenade', ['BZGAS'] = 'BZ Gas', ['FLARE'] = 'Flare',
    ['GAS_CANISTER'] = 'Gas Canister', ['EXTINGUISHER'] = 'Fire Extinguisher',
    ['PROGRAMMABLEAR'] = 'Programmable AR', ['TRAIN'] = 'Vehicle: Train',
    ['BARREL'] = 'Barrel', ['PROPANE'] = 'Propane', ['BLIMP'] = 'Blimp',
    ['DIR_FLAME_EXPLODE'] = 'Flame Explosion', ['TANKER'] = 'Vehicle: Tanker',
    ['PLANE_ROCKET'] = 'Plane Rocket', ['VEHICLE_BULLET'] = 'Vehicle Bullet',
    ['GAS_TANK'] = 'Gas Tank', ['RAILGUN'] = 'Railgun', ['FIREWORK'] = 'Fireworks',
    ['SNOWBALL'] = 'Snowball', ['PROXMINE'] = 'Proximity Mine',
    ['VALKYRIE_CANNON'] = 'Valkyrie Cannon', ['AIR_DEFENCE'] = 'Air Defence',
    ['PIPEBOMB'] = 'Pipe Bomb', ['VEHICLEMINE'] = 'Vehicle Mine',
    ['EXPLOSIVEAMMO'] = 'Explosive Ammo', ['APCSHELL'] = 'APC Shell',
    ['BOMB_CLUSTER'] = 'Bomb Cluster', ['BOMB_GAS'] = 'Bomb Gas',
    ['BOMB_INCENDIARY'] = 'Bomb Incendiary', ['BOMB_STANDARD'] = 'Bomb',
    ['TORPEDO'] = 'Torpedo', ['TORPEDO_UNDERWATER'] = 'Underwater Torpedo',
    ['BOMBUSHKA_CANNON'] = 'Bombushka Cannon', ['BOMB_CLUSTER_SECONDARY'] = 'Cluster Bomb',
    ['HUNTER_BARRAGE'] = 'Hunter Barrage', ['HUNTER_CANNON'] = 'Hunter Cannon',
    ['ROGUE_CANNON'] = 'Rogue Cannon', ['MINE_UNDERWATER'] = 'Underwater Mine',
    ['ORBITAL_CANNON'] = 'Orbital Cannon', ['BOMB_STANDARD_WIDE'] = 'Wide Bomb',
    ['EXPLOSIVEAMMO_SHOTGUN'] = 'Explosive Shotgun Ammo',
    ['OPPRESSOR2_CANNON'] = 'Oppressor Mk2 Cannon', ['MORTAR_KINETIC'] = 'Kinetic Mortar',
    ['VEHICLEMINE_KINETIC'] = 'Kinetic Mine', ['VEHICLEMINE_EMP'] = 'EMP Mine',
    ['VEHICLEMINE_SPIKE'] = 'Spike Mine', ['VEHICLEMINE_SLICK'] = 'Slick Mine',
    ['VEHICLEMINE_TAR'] = 'Tar Mine', ['SCRIPT_DRONE'] = 'Drone',
    ['RAYGUN'] = 'Ray Gun', ['BURIEDMINE'] = 'Buried Mine', ['SCRIPT_MISSIL'] = 'Missile',
    ['BIRD_CRAP'] = 'Bird Crap', ['BLIMP2'] = 'Blimp',
}
